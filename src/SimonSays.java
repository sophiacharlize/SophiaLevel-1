...
public class SimonSays extends KeyAdapter {
 ...
 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
  	images.put(new Integer(KeyEvent.VK_UP), "alt.jpg");
  	images.put(new Integer(KeyEvent.VK_DOWN), "d.jpg");
  	images.put(new Integer(KeyEvent.VK_LEFT), "delete.jpg");
  	images.put(new Integer(KeyEvent.VK_RIGHT), "v.jpg");
